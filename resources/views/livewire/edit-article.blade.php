    ...
    <form wire:submit="save">
        <div class="mb-3">
            <label wire:dirty.class="text-orange-400" wire:target="form.title" class="block" for="article-title">
                Title<span class="text-red-400" wire:dirty wire:target="form.title">*</span>
            </label>
            <input 
                type="text" 
        ...
        <div class="mb-3">
            <label wire:dirty.class="text-orange-400" wire:target="form.content" class="block" for="article-content">
                Content<span class="text-red-400" wire:dirty wire:target="form.content">*</span>
            </label>
            <textarea 
                id="article-content"
                class="p-2 w-full border rounded-md bg-gray-700 text-white"
        ...
        <div class="mb-3">
            <label wire:dirty.class="text-orange-400" wire:target="form.published" class="flex items-center">
                ...
                >
                Published<span class="text-red-400" wire:dirty wire:target="form.published">*</span>
            </label>
        </div>
        <div class="mb-3">
            <div>
                <div wire:dirty.class="text-orange-400" wire:target="form.notifications" class="mb-2">Notification Options<span class="text-red-400" wire:dirty wire:target="form.notifications">*</span></div>
